package be.bright.tools;

/*************************************************************************
 *  Compilation:  javac main.java.be.bright.tools.StdIn.java
 *  Execution:    java main.java.be.bright.tools.StdIn   (interactive test of basic functionality)
 *
...
/**
 *  The <tt>main.java.be.bright.tools.StdIn</tt> class provides static methods for reading strings
 ...
 *  mask. If the input begins with the optional byte-order mask, <tt>main.java.be.bright.tools.StdIn</tt>
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to main.java.be.bright.tools.StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from In to main.java.be.bright.tools.StdIn */

    /*** begin: section (2 of 2) of code duplicated from In to main.java.be.bright.tools.StdIn,
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from In to main.java.be.bright.tools.StdIn */
    
    
    // do this once when main.java.be.bright.tools.StdIn is initialized
    static {
        resync();
    }

    /**
     * If main.java.be.bright.tools.StdIn changes, use this to reinitialize the scanner.
     */
