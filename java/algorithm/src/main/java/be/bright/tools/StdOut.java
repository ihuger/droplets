 ...
 *  Compilation:  javac main.java.be.bright.tools.StdOut.java
 *  Execution:    java main.java.be.bright.tools.StdOut
 *
...
public final class StdOut {
    ...
    // assume language = English, country = US for consistency with main.java.be.bright.tools.StdIn
